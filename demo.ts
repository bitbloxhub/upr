...
//@ts-ignore: the above line asserts it works
console.log(pattern_named.exec('https://example.com/books/123').pathname.groups); // { id: '123' }
...
const pattern_repeating_minimum = new URLPattern('/books/:id+', 'https://example.com');
...
console.log(pattern_repeating_minimum.test('https://example.com/books/')); // false
console.log(pattern_repeating_minimum.test('https://example.com/books/123/456')); // true
console.log(pattern_repeating_minimum.test('https://example.com/books/123/456/789')); // true

// A repeating group with a minimum of zero
const pattern_repeating_optional = new URLPattern('/books/:id*', 'https://example.com');
...
console.log(pattern_repeating_optional.test('https://example.com/books/123/456')); // true
console.log(pattern_repeating_optional.test('https://example.com/books/123/456/789')); // true

// A group delimiter with a ? (optional) modifier
const pattern_optional_modifier = new URLPattern('/book{s}?', 'https://example.com');
...
//@ts-ignore: the above line asserts it works
console.log(pattern_optional_modifier.exec('https://example.com/books').pathname.groups); // {}

// A group delimiter without a modifier
const pattern_delimiter_no_modifier = new URLPattern('/book{s}', 'https://example.com');
...
const pattern_capturing_delimiter = new URLPattern({ pathname: '/blog/:id(\\d+){-:title}?' });
console.log(pattern_capturing_delimiter.test('https://example.com/blog/123-my-blog')); // true
console.log(pattern_capturing_delimiter.test('https://example.com/blog/123')); // true
console.log(pattern_capturing_delimiter.test('https://example.com/blog/my-blog')); // false

// A pattern with an optional group, preceded by a slash
const pattern_optional_slash = new URLPattern('/books/:id?', 'https://example.com');
...
const pattern_repeating_slash = new URLPattern('/books/:id+', 'https://example.com');
...
console.log(pattern_segment_outside_prefix.test('https://example.com#/books/123')); // true
...
console.log(pattern_wildcard_middle.test('https://example.com/folder/image.png')); // true
